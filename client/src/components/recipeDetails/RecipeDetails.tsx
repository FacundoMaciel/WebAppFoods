...
//import { RecipesDetailsInterface } from "../../Interfaces/Interfaces";
...
// )
const theRecipe:any = useSelector((state: RootState) => state.recipes.recipeDetails);
  ...
  return (
    <>
      <div className="flex flex-col justify-center items-center min-h-screen bg-gray-200 pt-20 text-center text-gray-900">
        ...
        <img className="md:w-[60%] md:h-[75%] w-full h-[h-40%]" src={brussels} alt="" />
        <h2 className="text-2xl font-bold text-gray-900 mt-2">
                Description
              </h2>
        <p className="bg-gray-200 pt-10 px-2">
          You may have noticed some changes around here. Most noticeably, where
          is Appetite for China and why is it now called Cinnamon Society? When
          I first started this blog in 2007, I had recently moved from New York
          to Beijing and was exploring China for the first time as a temporary
          resident. I wanted a blog to record my travels around the country and
          my experiments in the kitchen to reverse engineer all the new dishes I
          was trying. Because of Appetite for China, I made a bunch of new
          friends in the food world, started teaching cooking classes, and
          eventually started writing cookbooks. But this need to change the
          blog’s name has been 12 years in the making. When I moved back to the
          US in 2009, I knew I wanted to write about more than just Chinese
          food. (And I had already been doing that for newspapers and
          magazines.) But my partner at the time, who is now still a good a
          friend, kept telling me that changing the site name would hurt my SEO
          and to just leave it.
        </p>

        <div className="flex justify-center items-center bg-gray-200 pt-10">
          <div className="flex flex-col justify-center items-center ">
          <img className="md:w-[45%] md:h-[45%] w-full h-[h-40%]" src={image} alt="" />
          <h1 className="font-bold text-xl py-4">
          Brussel Sprouts with Roasted Red Peppers and Cider Vine
          </h1>
            <p className="border-2 border-white w-[90%] shadow-xl">
            You may have noticed some changes around here. Most noticeably, where
          is Appetite for China and why is it now called Cinnamon Society? When
          I first started this blog in 2007, I had recently moved from New York
          to Beijing and was exploring China for the first time as a temporary
